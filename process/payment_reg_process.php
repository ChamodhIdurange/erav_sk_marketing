...
$stmt = $conn->prepare($updateSQL);
$stmt->bind_param("sssssssssss", $head_k, $paymentNarration, $debitBranch, $debitAccount, $debitBranchColcode, $debitAccountColcode, $setCash, $setCheque, $invoiceNo, $paidAmount, $userID);
$ResultOut = $stmt->execute();
