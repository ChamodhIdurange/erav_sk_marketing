                                        ...
                                        <tr>
                                            ...
                                            <?php if($editcheck==1){ ?>
                                                <button
                                                    ...
                                                    id="<?php echo $row['idtbl_sub_product_category'] ?>"><i
                                                        data-feather="edit-2"></i></button>
                                                <?php } if($statuscheck==1 && $row['status']==1){ ?>
                                                <button
                                                    data-url="process/statussubproduct.php?record=<?php echo $row['idtbl_sub_product_category'] ?>&type=2"
                                                    data-actiontype="2"
                                                    class="btn btn-outline-success btn-sm btntableaction"><i
                                                        data-feather="check"></i></button>
                                                <?php } else if($statuscheck==1 && $row['status']==2){ ?>
                                                <button
                                                    data-url="process/statussubproduct.php?record=<?php echo $row['idtbl_sub_product_category'] ?>&type=1"
                                                    data-actiontype="1"
                                                    class="btn btn-outline-warning btn-sm btntableaction"><i
                                                        data-feather="x-square"></i></button>
                                                <?php } if($deletecheck==1){ ?>
                                                <button
                                                    data-url="process/statussubproduct.php?record=<?php echo $row['idtbl_sub_product_category'] ?>&type=3"
                                                    data-actiontype="3"
