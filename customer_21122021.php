                                ...
                                <form action="process/customerprocess.php" method="post" autocomplete="off">
                                    ...
                                    <div class="form-row mb-1">
                                        <div class="col">
                                            ...
                                            <select name="cusArea" id="cusArea" class="form-control form-control-sm" required>
                                                <option value="">Select</option>
                                    ...
                                    <div class="form-row mb-1">
                                        <div class="col">
                                            ...
                                            <input type="text" class="form-control form-control-sm" id="personpayment" name="personpayment" placeholder="">
                                        </div>
                                        <div class="col">
                                            <label class="small font-weight-bold text-dark">Mobile*</label>
                                            <input type="text" class="form-control form-control-sm" id="paymentmobile" name="paymentmobile" required>
                                        </div>
                                    </div>
                                    <div class="form-row mb-1">
                                        <div class="col">
                                            <label class="small font-weight-bold text-dark">Delivery person</label>
                                            <input type="text" class="form-control form-control-sm" id="deliveryperson" name="deliveryperson" placeholder="">
                                        </div>
                                        <div class="col">
                                            <label class="small font-weight-bold text-dark">Mobile*</label>
                                            <input type="text" class="form-control form-control-sm" id="deliverymobile" name="deliverymobile" required>
                                        </div>
                                    </div>
                                    <div class="form-row mb-1">
                                        <div class="col">
                                    ...
                                    <div class="form-group mb-1">
                                        ...
                                        <input type="text" class="form-control form-control-sm" id="ref" name="ref" placeholder="">
                                    </div>
                                    <div class="form-group mb-1">
                                    ...
                                    <div class="form-group mb-1">
                                        ...
                                        <select name="cusVisitDays[]" id="cusVisitDays" class="form-control form-control-sm" multiple>
