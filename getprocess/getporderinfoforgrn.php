...
$sqlorderdetail = "SELECT tbl_porder_detail.unitprice, tbl_porder_detail.saleprice, tbl_porder_detail.qty, tbl_product.product_name, tbl_product.idtbl_product 
...
while ($roworderdetail = $resultorderdetail->fetch_assoc()) {
    ...
    <tr>
        ...
        <td class="d-none"><?php echo $roworderdetail['saleprice'] ?></td>
        <td class="text-right"><?php echo number_format($roworderdetail['unitprice'], 2) ?></td>
        <td class="text-right"><?php echo number_format($roworderdetail['saleprice'], 2) ?></td>
